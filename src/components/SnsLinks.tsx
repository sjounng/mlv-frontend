...
type Sns = {
  ...
  href: string;
  icon: string;
  /** 호버 시 채워질 브랜드 배경색 (피드백 지정 hex) */
  hex: string;
};

const snsLinks: Sns[] = [
  { label: "디스코드", href: siteConfig.sns.discord, icon: "/assets/sns/discord_icon.svg", hex: "#3ccb0e" },
  { label: "네이버 카페", href: siteConfig.sns.naver, icon: "/assets/sns/naver_icon.svg", hex: "#5662f6" },
  { label: "X", href: siteConfig.sns.x, icon: "/assets/sns/x_icon.svg", hex: "#131313" },
  { label: "인스타그램", href: siteConfig.sns.instagram, icon: "/assets/sns/instagram_icon.svg", hex: "#e2366b" },
];
